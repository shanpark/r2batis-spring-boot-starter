...
public class MapperContext {
    ...
    /**
     * 현재 모든 branch에서 유효한 paramMap 들을 모두 합쳐서 반환한다.
     * @return 모든 branch의 paramMap들의 값들을 하나의 Map으로 만들어서 반환.
     */
    public Map<String, Object> getParamMap() {
        Map<String, Object> newParamMap = new HashMap<>();
        branchStack.forEach(branch -> newParamMap.putAll(branch.paramMap));
        return newParamMap;
    }
    ...
    public Set<String> getBindSet() {
        ...
        return branchStack.get(0).placeholderMap.keySet();
    }
    ...
    public Class<?> getPlaceholderType(String placeholder) {
        // 항상 generation이 끝난 후에 호출되므로 branchStack에는 1건만 있어야 한다.
        return branchStack.get(0).placeholderMap.get(placeholder);
    }
    ...
    public void expandPlaceholder(String placeholder, String newPlaceholder) {
        ...
        Object value = curBranch.paramMap.remove(placeholder);
        if (value != null)
            curBranch.paramMap.put(newPlaceholder, value);
    }
